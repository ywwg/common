...
// oops this is a mistake.  This is not the path for query-side decoding of names
// func TestProtoUnescaping(t *testing.T) {
// 	tests := []struct {
// 		name   string
...
// 		},
// 		{
// 			name:   "utf8 fails when scheme is legacy (bad content negotiation??)",
...
// 				Metric: []*dto.Metric{},
// 			},
// 			err: `invalid metric name "gauge.name\""`,
// 		},
// 		{
// 			name:   "utf8 unescaping, but the model still does not support it",
// 			scheme: model.LegacyValidation,
// 			escaping: model.ValueEncodingEscaping,
// 			in: &dto.MetricFamily{
// 				Name: proto.String("U__gauge_2e_name"),
// 				Help: proto.String("gauge\ndoc\nstr\"ing"),
// 				Type: dto.MetricType_GAUGE.Enum(),
// 				Metric: []*dto.Metric{},
// 			},
...
// 						Label: []*dto.LabelPair{
// 							{
// 								Name:  proto.String("U__name_2e_1"),
// 								Value: proto.String("val with\nnew line"),
// 							},
// 							{
// 								Name:  proto.String("U__name_2a_2"),
// 								Value: proto.String("val with \\backslash and \"quotes\""),
// 							},
// 						},
// 						Gauge: &dto.Gauge{
...
// 		},
// 		{
// 			name:   "dots unescaping",
// 			scheme: model.UTF8Validation,
// 			escaping: model.DotsEscaping,
// 			in: &dto.MetricFamily{
// 				Name: proto.String("gauge_dot_name"),
// 				Help: proto.String("gauge\ndoc\nstr\"ing"),
// 				Type: dto.MetricType_GAUGE.Enum(),
// 				Metric: []*dto.Metric{
// 					{
...
// 			model.NameValidationScheme = test.scheme
// 			d := &protoDecoder{
// 				r:        nil,
// 				escaping: test.escaping}

// 			fmt.Println("escaping?", d.escaping)

// 			processed := proto.Clone(test.in).(*dto.MetricFamily)
// 			err := d.processDecoded(processed)

// 			if (test.err == "" && err != nil) || (err != nil && err.Error() != test.err) || (err == nil && test.err != "")  {
// 				t.Errorf("case %d: error mismatch, want %v got %v", i, test.err, err)
// 			} 
// 			if err == nil && !cmp.Equal(test.want, processed,  cmpopts.IgnoreUnexported(unexportList...)) {
// 				t.Errorf("case %d: result mismatched: %s", i, cmp.Diff(test.want, processed, cmpopts.IgnoreUnexported(unexportList...)))
// 			}
// 		})
// 	}
// }
